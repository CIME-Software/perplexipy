...
- The **using-perplexipy.ipynb** tutorial notebook - see: https://github.com/CIME-Software/perplexipy/issues/18
...
Usage
=====
See the **using-perplexipy.ipynb** (https://github.com/CIME-Software/perplexipy/issues/18) notebook for a richer example of the API's
capabilities.
