% perplexipy(3) Version 0.0.9 | Perplexity AI high level API documentation
...
- The complete **PerplexiPy API reference** on GitHub Pages
- The <a href='https://github.com/CIME-Software/perplexipy/blob/master/PerplexiPy.ipynb' target='_blank'>PerplexiPy-tutorial.ipynb</a> tutorial notebook
...
Usage
=====
See the <a href='https://github.com/CIME-Software/perplexipy/blob/master/PerplexiPy.ipynb' target='_blank'>PerplexiPy-tutorial.ipynb</a> notebook for a richer example of the API's
capabilities.
